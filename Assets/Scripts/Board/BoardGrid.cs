...
public class BoardGrid
{
    ...
    public void CreateFace(GameObject face, GameObject vertex, GameObject edge, int col, int row)
    {
        ...
        faceObject.GetComponent<FaceBehaviour>().col = col;
        faceObject.GetComponent<FaceBehaviour>().row = row;
    ...
    public void CreateVertex(GameObject vertex, int col, int row, VertexSpecifier vertexSpec)
    {
        ...
        vertexObject.GetComponent<VertexBehaviour>().col = col;
        vertexObject.GetComponent<VertexBehaviour>().row = row;
        vertexObject.GetComponent<VertexBehaviour>().vertexSpec = vertexSpec;
    ...
    public void CreateEdge(GameObject edge, int col, int row, EdgeSpecifier edgeSpec)
    {
        ...
        edgeObject.GetComponent<EdgeBehaviour>().col = col;
        edgeObject.GetComponent<EdgeBehaviour>().row = row;
        edgeObject.GetComponent<EdgeBehaviour>().edgeSpec = edgeSpec;
