...
public class BoardBehaviour : MonoBehaviour
{
    ...
    public void MoveRobberToDesert()
    {
        ...
        for(int i = 0; i < tileObjects.Length; i++)
        {
            ...
            {
                robber.GetComponent<RobberBehaviour>().tile = tile;
            }
        }
    }
    ...
    {
        robber.GetComponent<RobberBehaviour>().tile = boardGrid.GetFace(col, row);
    }

    void LateUpdate()
    {
        if(robber.GetComponent<RobberBehaviour>().tile != null)
        {
            robber.transform.localPosition = robber.GetComponent<RobberBehaviour>().tile.transform.localPosition;
        }
    }
}
